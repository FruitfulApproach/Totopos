import { Arrow, ArrowStyle, CONSTANTS, Label, Shape } from "./arrow.js";
import { CubicBezier } from "./curve.js";
import { cancel, DOM, delay, pointer_event } from "./dom.js";
import { Colour, Dimensions, Enum, Offset, Point, Position, clamp, deg_to_rad, mod, rad_to_deg, url_parameters } from "./ds.js";
    ...
    initialise() {
        ...
        panes.push(new DOM.Div({ id: "about-pane", class: "pane hidden" })
            ...
            .add(new DOM.List(false, [
                ...
                new DOM.Element("li").add(
                    new DOM.Link("https://github.com/tjbcg", "ThÃ©ophile Cailliau", true)
            ...
            if (this.port === null || this.port.kind !== kind || this.port.format !== format) {
                ...
                if (this.port === null) {
                    ...
                    const quiver_package_version = new DOM.Select([
                            ...
                            ["1.2.0", "1.2.0 (TeX Live 2024 â€“ 2025)"]
                        ],
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    KaTeX = import("./KaTeX/katex.module.js").then((module) => {
