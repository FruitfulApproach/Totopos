...
import { Colour, Encodable, Point, Position, mod } from "./ds.js";
import { CONSTANTS } from "./arrow.js";
import { Parser } from "./parser.js";
import { Edge, Vertex } from "./ui.js";
                    ...
                    case "corner-inverse":
                        ...
                        switch (edge.options.style.name) {
                            ...
                            case "corner-inverse":
                                ...
                                // Round the angle to the nearest 45Âº, so that the corner always
...
QuiverExport.fletcher = new class extends QuiverExport {
    export(quiver, settings, options, definitions) {
        ...
        // Returns the coÃ¶rdinates of a cell, in the form `(x, y)`.
        ...
        for (let level = 1; level < quiver.cells.length; ++level) {
            ...
            for (const edge of quiver.cells[level]) {
                ...
                // source and target coÃ¶rdinates.
                ...
                // 1 â€“ 5 to the range 130deg â€“ 150deg.
