...
// ---------------------------------------------------------------- claims an
// arrow makes, and a node being rebuilt as another kind
//
// From the other line of work. Monic and epic live as Props here, while
// Arrow::Style says the same sort of thing as a drawn mark - the two were
// built in parallel and both are kept, so an arrow can be told it is monic
// either way (and, being two mechanisms, can be told both at once).
