...
namespace Emoji
{
	...
	inline QString add()         { return QStringLiteral("➕"); }       // heavy plus: put one more here
	...
	inline QString deleteMark()  { return QStringLiteral("✗"); }       // ballot X: struck off
	inline QString english()     { return QStringLiteral("\U0001F4AC"); }   // speech balloon: said in words
