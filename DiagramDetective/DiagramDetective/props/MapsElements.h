...
public:
	...
	enum ItemDataKey
	{
		...
		ImageSourceKey  = 2,   // the label of what it is the image of
...
private:
	...
	Node* imageOf(Category* codomain, const QString& functor, const QString& sourceId) const;
	void stamp(Node* image, const QString& functor, const QString& sourceId) const;
