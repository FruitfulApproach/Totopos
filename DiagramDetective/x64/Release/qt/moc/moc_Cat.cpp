...
namespace {
struct qt_meta_tag_ZN3CatE_t {};
} // unnamed namespace

template <> constexpr inline auto Cat::qt_create_metaobjectdata<qt_meta_tag_ZN3CatE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Cat, qt_meta_tag_ZN3CatE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Cat::staticMetaObject = { {
    QMetaObject::SuperData::link<Category::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN3CatE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN3CatE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN3CatE_t>.metaTypes,
    nullptr
} };
...
void *Cat::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN3CatE_t>.strings))
